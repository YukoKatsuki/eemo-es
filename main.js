...
function takeSnapshot()
{
    ...
    classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/HjfHhSdnq/model.json', modelLoaded);
